...
public class HttpUtils {
	...
	public static final String BASEHOST = "https://"+ (BuildConfig.DEBUG?"szdp":"dp") +".igrsservice.com";//测试
...
//	}
	...
	public void post(String url, Map<String, Object> map,
		...
		try{
			authorization= RSAUtils.getAuthorization(TabletApp.Companion.getApplication());
