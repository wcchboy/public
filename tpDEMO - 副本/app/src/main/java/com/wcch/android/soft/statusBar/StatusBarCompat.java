package com.wcch.android.soft.statusBar;
...
public class StatusBarCompat {
    ...
    public static void changeToLightStatusBar(@NonNull AppCompatActivity activity) {
    ...
    public static void cancelLightStatusBar(@NonNull AppCompatActivity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return;
        }
        if (activity == null) {
