...
public class ConfigUtil {
    ...
    public void setIdentification() {
        SharedPreferences config = App.getInstance().getApplicationContext().getSharedPreferences("config", Context.MODE_MULTI_PROCESS);
    ...
    public String getDeviceName() {
        SharedPreferences config = App.getInstance().getApplicationContext().getSharedPreferences("settingConfig", Context.MODE_PRIVATE);
