...
import com.igrs.betotablet.BuildConfig;
...
//                    }
    ...
    @Override
        ...
        L.e("ScreenRecordService->onStartCommand->" + this.hashCode() + " isScreenRecord:" + TabletApp.Companion.getApplication().isScreenRecord().get()
                + " mediaProjection:" + mediaProjection + " " + this.hashCode());
...
//                    OpusRecorder.getInstance().start(audioRecord);
    ...
    public void onDestroy() {
        ...
        TabletApp.Companion.getApplication().getApplication().isScreenRecord().set(false);
        exitHandler.removeMessages(0);
        try {
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.Q){
            try{
                ...
                if (mBluetoothDevice != null && mBluetoothDevice.getAddress().equals( TabletApp.Companion.getApplication().getApplication().getCurrent_device().device_mac)) {
