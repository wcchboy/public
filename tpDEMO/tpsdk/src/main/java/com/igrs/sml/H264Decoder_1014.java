...
public class H264Decoder_1014 extends Thread {
    ...
    private H264Decoder_1014() {

    }

    public H264Decoder_1014(LinkedBlockingQueue<byte[]> mH264DataQueue, Surface surface, String dev_id, DecoderCallback decoderCallback) {
        ...
        while (!isExit) {
            ...
            try {
                ...
                if (inputBufferIndex >= 0) {
                    ...
                    try {
                        int outputBufferIndex = mMediaCodec.dequeueOutputBuffer(bufferInfo, 5);
