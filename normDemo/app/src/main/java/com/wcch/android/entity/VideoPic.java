...
public class VideoPic {
    ...
    public VideoPic(int i, int i2, String str, String str2, String str3, long j, long j2, long j3) {
        this.id = i2;
        this.path = str;
        this.name = str2;
    ...
    public VideoPic(int i, int i2, String str, String str2, long j, long j2) {
        this.id = i2;
        this.path = str;
        this.name = str2;
        this.size = j;
